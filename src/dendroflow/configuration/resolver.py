...
resolve_deployment_reference_aliases = _resolve_deployment_reference_aliases
resolve_location_declarations = _resolve_location_declarations
resolve_location_label_declarations = _resolve_location_label_declarations
...
resolve_sensor_model_reference_aliases = _resolve_sensor_model_reference_aliases
